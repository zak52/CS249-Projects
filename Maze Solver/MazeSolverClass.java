...
public class MazeSolverClass
{
    ...
    public boolean solveMaze()
       {
        LocationData startLocation = new LocationData(getInitialDirection(), getStartY(), getStartX());
        
        return solveMazeHelper(setFirstPosition( startLocation, TRACK_MARKER));
       }
    ...
    {     
        ...
        else if (isWallAhead( currentLoc ) && isWallAhead( turnToLeft( currentLoc )) && 
        		isWallAhead( turnToRight( currentLoc )))
        {
        ...
        {
	        	if (!isWallAhead( currentLoc ) && 
	        			solveMazeHelper (moveToNextCell( currentLoc )))
	            {
	            	return true;
	            }
	        	else if(!isWallAhead( turnToRight( currentLoc )) 
	        			&& solveMazeHelper (turnToRight( currentLoc )))
	        	{
	        		return true;
	        	}
	        	else if(!isWallAhead( turnToLeft( currentLoc )) 
	        			&& solveMazeHelper (turnToLeft( currentLoc )))
	        	{
	        		return true;
	        	}
	        	else
